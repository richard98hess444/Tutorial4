...
Coord& NumVehicleMsg::getSenderPos()
{
...
LAddress::L2Type& NumVehicleMsg::getSenderAddress()
{
...
NumVehicleMsgDescriptor::NumVehicleMsgDescriptor() : omnetpp::cClassDescriptor("veins::NumVehicleMsg", "veins::BaseFrame1609_4")
{
...
int NumVehicleMsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='n' && strcmp(fieldName, "numVehicles")==0) return base+1;
    if (fieldName[0]=='t' && strcmp(fieldName, "timeStampP")==0) return base+2;
...
int NumVehicleMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    NumVehicleMsg *pp = (NumVehicleMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *NumVehicleMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string NumVehicleMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getNumVehicles());
        case 2: return simtime2string(pp->getTimeStampP());
        case 3: {std::stringstream out; out << pp->getSenderAddress(); return out.str();}
        default: return "";
    }
}

bool NumVehicleMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    NumVehicleMsg *pp = (NumVehicleMsg *)object; (void)pp;
    switch (field) {
        case 1: pp->setNumVehicles(string2long(value)); return true;
        case 2: pp->setTimeStampP(string2simtime(value)); return true;
...
void *NumVehicleMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
